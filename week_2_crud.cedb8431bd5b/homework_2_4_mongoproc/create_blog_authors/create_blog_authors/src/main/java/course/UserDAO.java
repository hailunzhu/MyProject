...
public class UserDAO {
    ...
    public boolean addUser(String username, String password, String email) {
        ...
        Document doc = new Document().append("_id", username).append("password",passwordHash);
    ...
    public Document validateLogin(String username, String password) {
        ...
        List<Document> all  = usersCollection.find(filter).into(new ArrayList<Document>());

        if (!all.isEmpty()) {
            System.out.println("is empty:"+all.toString());
